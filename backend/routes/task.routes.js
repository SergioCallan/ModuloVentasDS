...
const {addDetails, getSellDetails, deleteSell, registerSell, deleteDetail, getSelldni, getSellid, calculateCost}= require('../controllers/sell.controllers')
...
router.get('/calcularcoste/:id_venta', calculateCost)
